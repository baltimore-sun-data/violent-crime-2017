var violentCrime = {
	...
	charts: function(){
		...
		var timeData = [[7.5,7.4,5.5,2.9,1.8,1.3,0.7,0.6,0.4,0.8,1.9,2.5,2.4,2.5,4.3,4.8,4.3,5.0,4.6,5.2,6.4,8.9,8.2,10.1],[6.0,5.6,3.9,2.0,1.9,1.2,1.3,0.6,1.1,1.5,2.4,1.9,3.0,4.4,4.1,4.9,4.4,5.1,6.4,6.2,7.4,8.7,9.3,6.9]];
		...
		var timeChart = new Chart(time, {
			...
			data: {
				...
				datasets: [{
					...
					label: '2012 - 2014',
					backgroundColor: 'rgba(162,169,177,0.3)',
					borderColor: 'rgb(162,169,177)',
					pointBackgroundColor: 'rgb(162,169,177)',
					pointHitRadius: 30,
					data: timeData[0]
